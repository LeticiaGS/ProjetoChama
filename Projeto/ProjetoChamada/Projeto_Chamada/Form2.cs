    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                con = new MySqlConnection("server=143.106.241.3;port=3306;User ID=cl200475; database=cl200475; password=cl*20092002; SslMode=none;");
                con.Open();
                MySqlCommand busca_id = new MySqlCommand("Select idAlunos from Alunos where idAlunos=" + textBox1.Text, con);
                MySqlDataReader resultado = busca_id.ExecuteReader();
                if (resultado.Read())
                {
                    MessageBox.Show("Este ra já existe cadastrado no banco, favor inserir outro", "Erro de Cadastro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    con = new MySqlConnection("server=143.106.241.3;port=3306;User ID=cl200475; database=cl200475; password=cl*20092002; SslMode=none;");
